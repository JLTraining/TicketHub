...
namespace TicketHub.Controllers
{
    public class SaleHistoriesController : Controller
    {
        ...
        public SaleHistoriesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.SaleHistory.Include(s => s.Ticket).Include(s => s.User).Where(e => e.UserId == userId); ;
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,TicketId,Date,Price")] SaleHistory saleHistory)
        {
            ...
            ViewData["TicketId"] = new SelectList(_context.Ticket, "Id", "SellerId", saleHistory.TicketId);
            ViewData["UserId"] = new SelectList(_context.User, "Id", "Id", saleHistory.UserId);
            return View(saleHistory);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.SaleHistory'  is null.");
            }
            var saleHistory = await _context.SaleHistory.FindAsync(id);
            if (saleHistory != null)
            {
